                        ...
                        <div key={activeProject} className="space-y-8 p-6 animate-fadeInUp">
                            <div className="relative">
                                ...
                                <h3 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
                                    <Link to={`/projects/${projects[activeProject].id}`} className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                            ...
                            <div className="flex items-center gap-6 pt-4">
                                <Link to={`/projects/${projects[activeProject].id}`} className="flex items-center gap-2 text-gray-900 dark:text-white font-semibold hover:text-blue-600 dark:hover:text-blue-400 transition-colors text-lg">
